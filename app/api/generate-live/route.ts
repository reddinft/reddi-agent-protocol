  ...
  const stream = new ReadableStream({
    async start(controller) {
      ...
      try {
        ...
        // Step 7: Commit-reveal (real devnet TX)
        await new Promise((r) => setTimeout(r, 600));
        const mockRevealTx =
...
<body>
  <div class="container">
    ...
    <div class="meta">Generated by qwen3:8b via Ollama · Reddi Agent Protocol devnet · Slot ${devnetProof.slot}</div>
  </div>
</body>
</html>`;
