URL: https://quasar-lang.com/docs/core-concepts/instructions
FETCHED_FINAL: https://quasar-lang.com/docs/core-concepts/instructions.mdx
DEPTH: 0

# Instructions (/docs/core-concepts/instructions.mdx)
