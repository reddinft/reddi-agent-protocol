URL: https://quasar-lang.com/docs/features/remaining-accounts
FETCHED_FINAL: https://quasar-lang.com/docs/features/remaining-accounts.mdx
DEPTH: 1

# Remaining Accounts (/docs/features/remaining-accounts.mdx)
