URL: https://quasar-lang.com/docs/profiling/benchmarks
FETCHED_FINAL: https://quasar-lang.com/docs/profiling/benchmarks.mdx
DEPTH: 0

# Benchmarks (/docs/profiling/benchmarks.mdx)
