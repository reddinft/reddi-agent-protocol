URL: https://quasar-lang.com/docs/zero-copy/account-layout
FETCHED_FINAL: https://quasar-lang.com/docs/zero-copy/account-layout.mdx
DEPTH: 0

# Account Layout (/docs/zero-copy/account-layout.mdx)
