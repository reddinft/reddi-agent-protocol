URL: https://quasar-lang.com/docs/references/type-mapping
FETCHED_FINAL: https://quasar-lang.com/docs/references/type-mapping.mdx
DEPTH: 0

# Type Mapping (/docs/references/type-mapping.mdx)
