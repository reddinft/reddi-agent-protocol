URL: https://quasar-lang.com/docs/references/account-types
FETCHED_FINAL: https://quasar-lang.com/docs/references/account-types.mdx
DEPTH: 0

# Account Types (/docs/references/account-types.mdx)
