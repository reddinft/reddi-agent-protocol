URL: https://quasar-lang.com/docs/core-concepts/cpi
FETCHED_FINAL: https://quasar-lang.com/docs/core-concepts/cpi.mdx
DEPTH: 0

# Cross-Program Invocations (/docs/core-concepts/cpi.mdx)
