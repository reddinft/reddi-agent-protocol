URL: https://quasar-lang.com/docs/clients/typescript
FETCHED_FINAL: https://quasar-lang.com/docs/clients/typescript.mdx
DEPTH: 0

# TypeScript Client (/docs/clients/typescript.mdx)
