URL: https://quasar-lang.com/docs/core-concepts/pda
FETCHED_FINAL: https://quasar-lang.com/docs/core-concepts/pda.mdx
DEPTH: 0

# Program Derived Addresses (/docs/core-concepts/pda.mdx)
