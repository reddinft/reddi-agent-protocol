URL: https://quasar-lang.com/docs/core-concepts/program-structure
FETCHED_FINAL: https://quasar-lang.com/docs/core-concepts/program-structure.mdx
DEPTH: 0

# Program Structure (/docs/core-concepts/program-structure.mdx)
