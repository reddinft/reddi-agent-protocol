URL: https://quasar-lang.com/docs/references/configuration
FETCHED_FINAL: https://quasar-lang.com/docs/references/configuration.mdx
DEPTH: 0

# Configuration (/docs/references/configuration.mdx)
