URL: https://quasar-lang.com/docs/zero-copy/dynamic-fields
FETCHED_FINAL: https://quasar-lang.com/docs/zero-copy/dynamic-fields.mdx
DEPTH: 0

# Dynamic Fields (/docs/zero-copy/dynamic-fields.mdx)
