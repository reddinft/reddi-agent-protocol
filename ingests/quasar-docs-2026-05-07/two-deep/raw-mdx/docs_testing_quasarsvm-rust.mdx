URL: https://quasar-lang.com/docs/testing/quasarsvm-rust
FETCHED_FINAL: https://quasar-lang.com/docs/testing/quasarsvm-rust.mdx
DEPTH: 1

# QuasarSVM (Rust) (/docs/testing/quasarsvm-rust.mdx)
...
A complete test file for the [vault example program](/docs/guides/build-a-vault.mdx):
