URL: https://docs.magicblock.gg/pages/private-ephemeral-rollups-pers/api-reference/per/login
FETCHED_AS: https://docs.magicblock.gg/pages/private-ephemeral-rollups-pers/api-reference/per/login.md
FINAL: https://docs.magicblock.gg/pages/private-ephemeral-rollups-pers/api-reference/per/login.md
DEPTH: 2
...
````yaml /pages/private-ephemeral-rollups-pers/api-reference/per/openapi/login.openapi.json POST /v1/spl/login
openapi: 3.1.0
info:
