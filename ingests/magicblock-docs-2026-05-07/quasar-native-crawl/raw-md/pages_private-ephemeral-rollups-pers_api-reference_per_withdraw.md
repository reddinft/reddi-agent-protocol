URL: https://docs.magicblock.gg/pages/private-ephemeral-rollups-pers/api-reference/per/withdraw
FETCHED_AS: https://docs.magicblock.gg/pages/private-ephemeral-rollups-pers/api-reference/per/withdraw.md
FINAL: https://docs.magicblock.gg/pages/private-ephemeral-rollups-pers/api-reference/per/withdraw.md
DEPTH: 2
...
````yaml /pages/private-ephemeral-rollups-pers/api-reference/per/openapi/withdraw.openapi.json POST /v1/spl/withdraw
openapi: 3.1.0
info:
