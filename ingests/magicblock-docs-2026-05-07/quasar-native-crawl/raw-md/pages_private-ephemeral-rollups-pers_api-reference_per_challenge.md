URL: https://docs.magicblock.gg/pages/private-ephemeral-rollups-pers/api-reference/per/challenge
FETCHED_AS: https://docs.magicblock.gg/pages/private-ephemeral-rollups-pers/api-reference/per/challenge.md
FINAL: https://docs.magicblock.gg/pages/private-ephemeral-rollups-pers/api-reference/per/challenge.md
DEPTH: 2
...
````yaml /pages/private-ephemeral-rollups-pers/api-reference/per/openapi/challenge.openapi.json GET /v1/spl/challenge
openapi: 3.1.0
info:
