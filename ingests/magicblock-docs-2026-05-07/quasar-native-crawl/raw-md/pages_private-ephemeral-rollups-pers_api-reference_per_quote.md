URL: https://docs.magicblock.gg/pages/private-ephemeral-rollups-pers/api-reference/per/quote
FETCHED_AS: https://docs.magicblock.gg/pages/private-ephemeral-rollups-pers/api-reference/per/quote.md
FINAL: https://docs.magicblock.gg/pages/private-ephemeral-rollups-pers/api-reference/per/quote.md
DEPTH: 2
...
````yaml /pages/private-ephemeral-rollups-pers/api-reference/per/openapi/quote.openapi.json GET /v1/swap/quote
openapi: 3.1.0
info:
