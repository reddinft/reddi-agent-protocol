...
| MagicBlock | Live Quasar-native permission/delegation + TEE private authorization proof, not successful private payee settlement claim | `docs/MAGICBLOCK-QUASAR-TEE-REPRO-2026-05-07.md`; `docs/QUASAR-MAGICBLOCK-PER-BDD-PLAYBOOK-2026-05-07.md`; `docs/MAGICBLOCK-PER-TEE-VALIDATION-2026-05-07.md` | createPermission + delegatePermission + escrow delegation succeed live; patched Quasar PER executes inside MagicBlock TEE for private authorization/commit evidence, but final Quasar demo does not claim private payee lamport settlement |
